...
summary_stats <- tibble(
    metric = c("Total Admissions", "Total Neonatal Deaths", "NND Prevalence (%)"),
    value = c(n_total_admissions, n_total_nnd, round(100 * n_total_nnd / n_total_admissions, 2))
)
write_csv(summary_stats, file.path(output_dir, "00_summary_stats.csv"))
cat("Saved: 00_summary_stats.csv\n")
