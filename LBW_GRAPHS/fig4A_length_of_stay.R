# ==============================================================================
# fig4A_length_of_stay.R
# FIGURE 4A — Median Length of Stay by SVN Category and Facility
...
cat("\n===== Figure 4A: Median LOS by SVN category and facility =====\n")
...
# ------------------------------------------------------------------------------
# FIGURE 4A — Median LOS with IQR, by SVN category and facility
# ------------------------------------------------------------------------------
fig4A <- ggplot(los_fac, aes(
  ...
  labs(
    title    = "Median length of stay by SVN category and facility",
...
save_figure(fig4A, "fig4A_length_of_stay", width = 8, height = 7)
cat("Figure 4A complete.\n")
