...
#
# Source: Q21_outputs/02_steroids_outcomes_SGA_wide.csv
# ==============================================================================
...
# FIGURE 7C
# ------------------------------------------------------------------------------
fig7C <- ggplot(steroid_uptake, aes(
  ...
  labs(
    title    = "Antenatal corticosteroid use by SVN category",
...
save_figure(fig7C, "fig7C_risk_factors", width = 8, height = 7)
cat("Figure 7C complete.\n")
